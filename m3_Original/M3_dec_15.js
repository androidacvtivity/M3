...
//But without the comma after the zero here. Here integers not floats
        ...
        // Perform comparison after parsing float values
        if (!isNaN(parseFloatWithCharacter(values.CAPV_R3_1_1_C1)) && !isNaN(parseFloatWithCharacter(values.CAPV_R3_1_C1)) && parseFloatWithCharacter(values.CAPV_R3_1_1_C1) > parseFloatWithCharacter(values.CAPV_R3_1_C1)) {
            webform.errors.push({
                'fieldName': 'CAPV_R3_1_1_C1',
                'index': 0,
                'weight': 94,
