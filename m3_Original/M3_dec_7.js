...
//------------------------------------------------------------------------------
        ...
        var result03031 = 0;
        result03031 = (parseFloat(values.CAPV_R6_C1) + parseFloat(values.CAPV_R7_C1) + parseFloat(values.CAPV_R8_C1)
            + parseFloat(values.CAPV_R9_C1) + parseFloat(values.CAPV_R10_C1)).toFixed(1);

        var v_CAPV_R5_C1 = 0;
        v_CAPV_R5_C1 = parseFloat(values.CAPV_R5_C1).toFixed(1);

        // Check if v_CAPV_R5_C1 is less than result03031
        if (parseFloat(v_CAPV_R5_C1) < parseFloat(result03031)) {
            webform.errors.push({
                'fieldName': 'CAPV_R5_C1',
                'index': 0,
                'weight': 31,
