...
//---------------------------------------------------
    ...
    function validate_rule_03064_1_F(values) {
        ...
        // asigurăm că "values" este obiect
        values = values || {};
        ...
        // Lista filialelor CUATM – în cazul nostru: CAPIa_CUATM_R_FILIAL
        var filList = values.CAPIa_CUATM_R_FILIAL;
        ...
        for (var j = 0; j < filList.length; j++) {
            ...
            if (result00_T_F !== 0 && result01_T_F === 0) {
                webform.warnings.push({
                    ...
                    msg: Drupal.t(
                        'Raion: @CUATM - Cod eroare: 03-064. ' +
                        'Pe rândul "Total salariați" (R00-T) există valori pe coloanele 2–10, ' +
                        'dar pe rândul "Total salariați" (R01-T) nu există valori pentru CAEM principal ' +
                        '(filiala CUATM @CUATM).',
