...
/* ==========================================================================
 * R01-ONLY PATCH: AUTOSUMĂ pentru CAPIa (R01; Total & Femei)
...
(function ($, Drupal) {
    ...
    window.watchAutoSum_CAPIa_R01_ONLY = function () {
    ...
    $(function () {
        if (typeof window.watchAutoSum_CAPIa_R01_ONLY === 'function') {
            window.watchAutoSum_CAPIa_R01_ONLY();
        }
